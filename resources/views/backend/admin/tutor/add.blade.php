      ...
      <div class="row align-items-lg-center h-100">
         ...
         <div class="col-12 col-lg-11 offset-lg-1 h-100">
            ...
            <div class="hero-main-content">
               <h2 class="hero-title text-capitalize">{{ __('admin.Add_Tutor') }}</h2>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-11 offset-lg-1">
                     ...
                     <div class="find-multi-search-box booking-form-container">
                        <form action="{{ url('admin/tutor/add') }}" method="post" class="booking-form request-form" enctype="multipart/form-data">
                           {{ csrf_field() }}
...
{{ __('admin.Select_Category_Name') }}
                                 ...
                                 <div class="form-group">
                                    <label style="font-size: 18px;">{{ __('admin.Level_of_Teacher') }} </label>
                               ...
                               <div class="form-group">
                                    ...
                                    <select name="experience_of_teacher" required class="request-lang-multi form-control">
                                       ...
                                       @for($i=1; $i<=50; $i++)
                                          <option @if (old('experience_of_teacher') == ($i)) {{ 'selected' }} @endif value="{{ $i }}">{{ $i }} {{ __('admin.Years') }}</option>
                                       @endfor
                                    </select>
                                 </div>
         ...
         <div class="form-group title-field">
            ...
            <input type="text" name="hour_per_rate" class="request-title form-control" placeholder="{{ __('admin.Price_For_Each_Lesson') }}" value="{{ old('hour_per_rate') }}">
         </div>
      ...
      <div class="form-group ">
         @foreach($getlanguage as $value_l)
            <label style="font-weight: normal;margin-right: 20px;">
               <input  type="checkbox" name="language[]" @if(is_array(old('language')) && in_array($value_l->id, old('language'))) checked @endif  value="{{ $value_l->id }}"> {{ $value_l->language_name }}
            </label>
            <br />
         @endforeach
      </div>
