                          ...
                          <tr class="single-course-item">
                            ...
                            <td class="teacher-name" data-title="Teacher name">
                                ...
                                @endif
                                  ...
                                  <span class="name" style="text-transform: capitalize;">{{ $value->getusers->name }} {{ $value->getusers->last_name }}</span>
                                 </span>
                              </td>
                            <td class="teacher-name" data-title="Teacher name">
                                <span class="info-wrap">
                            ...
                            <td>
                                ...
                                <a href="{{ url('admin/lesson/view/'.$value->id) }}" class="btn btn-primary"><i class="far fa-eye"></i></a>
                            </td>
                          </tr>
                        @empty
