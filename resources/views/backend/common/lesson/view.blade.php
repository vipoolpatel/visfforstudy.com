      ...
      <div class="row">
         <div class="col-6">
            <div class="breadcrumb-items d-flex align-items-center">
               ...
               <a href="#" class="text-capitalize">Lesson Detail</a>
               </span>
            </div>
         </div>
         <div class="col-6" style="text-align: right;">
            <a href="{{ url('tutor/lesson') }}" class="btn btn-primary">{{ __('student.Back') }}</a>
         </div>
      </div>
   </div>
</div>
                  ...
                  <div class="lesson-detail-tabulation course-tabulation w-100">
                     <div class="tabulation-header d-flex justify-content-between align-items-center">
                        <ul class="nav nav-tabs">
                           ...
                           <li>
                              <a data-toggle="tab" href="#detailChatTab">Student Detail</a>
                           </li>
                           @endif
                        </ul>
                        <div class="tabulation-header-buttons">
                           @if(Auth::user()->is_admin != 2)
                           @if($value->status == '1' && Auth::user()->is_admin == 3)
                              ...
                              <div id="lessonDetailTab" class="tab-pane in active lesson-detail-main">
                                 ...
                                 <div class="detail-tab-box course-meta-box d-md-flex justify-content-between">
                                    <span class="meta-item name">
                                       ...
                                       <p class="desc" style="text-transform: capitalize;">{{ !empty($value->getcourse->getcategory->category_name) ? $value->getcourse->getcategory->category_name : '' }}</p>
                                    </span>
                                    <span class="meta-item start-time text-md-center">
                                       <p class="label">Start Date</p>
                                       <p class="desc">{{ date('Y-m-d',$value->getlesson->lesson_time) }}</p>
                                    </span>
                                    <span class="meta-item due-time text-md-center">
                                       <p class="label">Start Time</p>
                                       <p class="desc">{{ date('h:i A',$value->getlesson->lesson_time) }}</p>
                                    </span>
                                    <span class="meta-item text-md-center">
                                       <p class="label">Duration</p>
                                       <p class="desc">{{ $value->getlesson->duration }} Minutes</p>
                                    </span>
                                 </div>
                                 <div class="detail-tab-box course-meta-box d-md-flex justify-content-between">
                                    <span class="meta-item start-time text-md-center">
                                       <p class="label">{{ __('student.Price_For_Each_Lesson') }}</p>
                                       <p class="desc">${{ number_format($value->lesson_per_rate,2) }}</p>
                                    </span>
                                    <span class="meta-item due-time text-md-center">
                                       <p class="label">Lesson Type</p>
                                       <p class="desc">{{ $value->getlessontype->request_type_name }}</p>
                                    </span>
                                    <span class="meta-item text-md-center">
                                       <p class="label">Level</p>
                                       <p class="desc">{{ $value->getlevelname->level_of_student_name }}</p>
                                    </span>
   ...
   <div class="modal-dialog modal-sm">
      <div class="modal-content">
         ...
         <form action="{{ url('student/lesson/complete/'.$value->id) }}" method="post">
            {{ csrf_field() }}
            <input type="hidden" name="order_course_id" value="{{ $value->id }}">
