      ...
      <div class="row align-items-lg-center h-100">
         ...
         <div class="col-12 col-lg-11 offset-lg-1 h-100">
            ...
            <div class="hero-main-content">
               <h2 class="hero-title text-capitalize">{{ __('student.Create_your_request') }}</h2>
   ...
   <div class="container">
               ...
               <div class="row">
                  <div class="col-lg-11 offset-lg-1">
                     <div class="find-multi-search-box booking-form-container">
                        <form action="{{ url('student/request-add') }}" method="post" class="booking-form request-form" enctype="multipart/form-data">
                           {{ csrf_field() }}
                           <div class="form-group title-field">
                              <label for="request-title"> {{ __('student.Request_title') }}</label>
                              <input type="text" name="request_title" required class="request-title form-control" placeholder="Enter your request title">
                           </div>
                           <div class="multi-search-form d-flex align-items-end">
                              <div class="input-group">
                             
                                 <div class="form-group">
                                    <label style="font-size: 18px;">{{ __('student.Level_of_Student') }} </label>
                                    <select name="level_of_student_id" required class="request-aim-multi form-control">
                                       <option value="">
                                       {{ __('student.Select_Level_of_Student') }}
                                        </option>
                                       @foreach($getlevelofstudent as $value_level)
                                       <option value="{{ $value_level->id }}">{{ $value_level->getlevelofstudentname() }}</option>
                                       @endforeach
                                    </select>
                                 </div>
                                 <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <select name="language_id" required class="request-lang-multi form-control">
                           ...
                           <div class="form-group title-field">
                              <label for="request-title">{{ __('student.Price_For_Each_Lesson') }}</label>
                              <input type="text" name="rate_per_hour" class="request-title form-control" placeholder="{{ __('student.Enter_Your_Price_For_Each_Lesson') }}" required>
                           </div>
                           <div class="book-form-check custom">
                              <h5 class="label">{{ __('student.What_type_of_lesson_do_you_need') }}</h5>
                                 ...
                                 <div class="form-group d-inline-flex align-items-center mb-0 mr-4">
                                    <input type="radio" name="request_type_id"  required id="getRequestType{{ $type->id }}" class="reg-check form-check-input" value="{{ $type->id }}">
                           ...
                           <div class="time-picker">
                              <div class="form-group">
                                 ...
                                 <div class="form-check-inline">
                                 	<input type="date" name="lesson_date" required class="book-time form-control">
                                 	<span class="time-picker-separator">&amp;</span>
                                    <input type="time" name="lesson_time" required id="request-time-from" style="padding: 0px;" class="book-time form-control">
                                    <span class="time-picker-separator">&amp;</span>
                                    <input type="text" name="duration" required placeholder="Duration(60 Minutes)" id="request-time-to" class="book-time form-control">
                                 </div>
                              </div>
                           </div>
      <div class="text-message">
         <div class="form-group">
            ...
            {{ __('student.What_do_you_want_to_learn') }}
            </label>
            <textarea name="request_description" required id="request-message" class="booking-message request-message form-control" placeholder="{{ __('student.Type_a_Description') }}" cols="10" rows="5"></textarea>
         </div>
      </div>
                           <button type="submit" class="request-submit-btn reg-signup-btn text-capitalize">
{{ __('student.Create_Request') }}
                          </button>
                        </form>
                     </div>
                  </div>
