         ...
         <td class="action" data-title="Action">        
            <span class="action-btn-wrap">
                @if($getdata->type == 'request')
                  <a href="{{ url('student/request-page/view/'.$getdata->common_id) }}" class="button view-btn"><i class="far fa-eye"></i></a>
                @elseif($getdata->type == 'offer')
                  <a href="{{ url('student/offer-page/view/'.$getdata->common_id) }}" class="button view-btn"><i class="far fa-eye"></i></a>
                @endif
            </span>
         </td>
      </tr>
