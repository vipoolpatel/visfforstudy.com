  				...
  				<div class="col-12">
  					<div class="breadcrumb-items d-flex align-items-center">
  						<span class="breadcrumb-trail">
  							<a href="#" class="text-capitalize">Booking Course</a>
  						</span>
                        ...
                        @forelse($getOrder as $value)
                            ...
                            <td>{{ $value->id }}</td>
                                ...
                                <a href="{!! $value->getusers->getProfileTutorLink() !!}">
  															<span class="name">{{ $value->getusers->name }} {{ $value->getusers->last_name }}</span>
                                </a>
  														</span>
  													</td>
                                ...
                                <a href="{{ url('student/course/view/'.$value->id) }}" class="btn btn-primary"><i class="far fa-eye"></i></a>
                            </td>
  												</tr>
                        @empty
