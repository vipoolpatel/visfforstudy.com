      ...
      <div class="row">
         <div class="col-6">
            <div class="breadcrumb-items d-flex align-items-center">
               ...
               <a href="#" class="text-capitalize">{{ __('tutor.View_Course_Detail') }}</a>
               </span>
            </div>
         </div>
         <div class="col-6" style="text-align: right;">
	         <a href="{{ url('tutor/course/edit/'.$value->id) }}" class="btn btn-success">{{ __('tutor.Edit') }}</a>
			 <a href="{{ url('tutor/course') }}" class="btn btn-danger">{{ __('tutor.Back') }}</a>
		</div>
      </div>
   </div>
</div>
...
{{ __('tutor.Created_Date') }}
                                 ...
                                 <div class="detail-tab-box course-description">
                                    <h6 class="label text-capitalize">{{ __('tutor.Description') }}</h6>
                                    <p>
                                       {!! $value->description !!}
                                    </p>
                                 </div>
                        ...
                        <div class="col-lg-4">
                           <div class="notes-box d-flex flex-column">
                              ...
                              <div class="form-group time-picker" style="text-align: center;">
                                 <h5 for="publish-start-time">{{ __('tutor.Subject_List') }}</h5>
                                 <br />
                                 <table class="table">
...
{{ __('tutor.Chosed_start_date_time_and_duration') }}
                                 ...
                                 <div>
                                    <div class="initial-field with-btn">
                                       ...
                                       <span class="time-picker-separator">-</span>
                                       {{ $values->duration }} {{ __('tutor.Minutes') }}
