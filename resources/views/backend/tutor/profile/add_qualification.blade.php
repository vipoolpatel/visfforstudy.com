      ...
      <div class="row align-items-lg-center h-100">
         ...
         <div class="col-12 col-lg-11 offset-lg-1 h-100">
            ...
            <div class="hero-main-content">
               <h2 class="hero-title text-capitalize">{{ __('tutor.Add_new_Qualification') }}</h2>
                     ...
                     <div class="find-multi-search-box booking-form-container">
                        <form action="" method="post" class="booking-form request-form" enctype="multipart/form-data">
                           ...
                           <div class="form-group title-field">
                              ...
                              <input type="text" name="university_name" class="request-title form-control" placeholder="{{ __('tutor.University_Name') }}" required>
                           </div>

                           <div class="form-group title-field">
                              <label for="request-title">{{ __('tutor.Degree') }} </label>
                              <input type="text" name="degree" class="request-title form-control" placeholder="{{ __('tutor.Degree') }}" required>
                           </div>

                           <div class="form-group title-field">
                              <label for="request-title">{{ __('tutor.Major') }} </label>
                              <input type="text" name="major" class="request-title form-control" placeholder="{{ __('tutor.Major') }}" required>
                           </div>

                           <div class="form-group title-field">
                              <label for="request-title">{{ __('tutor.Start_Year') }} </label>
                              <input type="date" name="start_year" style="padding: 0px;padding-left: 10px;" class="request-title form-control" placeholder="{{ __('tutor.Start_Year') }}" required>
                           </div>

                           <div class="form-group title-field">
                              <label for="request-title">{{ __('tutor.End_Year') }} </label>
                              <input type="date" name="end_year" style="padding: 0px;padding-left: 10px;" class="request-title form-control" placeholder="{{ __('tutor.End_Year') }}" required>
                           </div>
                           ...
                           <div class="text-message">
                              <div class="form-group">
                                 ...
                                 <textarea name="description" required id="request-message" class="booking-message request-message form-control" placeholder="{{ __('tutor.Type_a_Description') }}" cols="10" rows="5"></textarea>
                              </div>
                           </div>

                           <button type="submit" class="request-submit-btn reg-signup-btn text-capitalize">{{ __('tutor.Save') }}</button>
